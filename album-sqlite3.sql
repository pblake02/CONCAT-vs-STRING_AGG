...
INSERT INTO album (id, title, artist, label, released) VALUES (2,'Hendrix in the West','Jimi Hendrix','Polydor','1972-01-00');
INSERT INTO album (id, title, artist, label, released) VALUES (3,'Rubber Soul','The Beatles','Parlophone','1965-12-03');
...
INSERT INTO album (id, title, artist, label, released) VALUES (14,'Kind of Blue','Miles Davis','Columbia','1959-08-17');
INSERT INTO album (id, title, artist, label, released) VALUES (89,'Kind of Blue2','Miles Davis','Columbia','1959-08-17');
INSERT INTO album (id, title, artist, label, released) VALUES (90,'Kind of Blue3','Miles Davis','Columbia','1959-08-17');



--delete from album where album.id = 2;
--delete from track where track_number = 2;
...
INSERT INTO track (id, album_id, title, track_number, duration) VALUES (1,1,'Bright Lights Big City',1,320);
  ...
  INSERT INTO track (id, album_id, title, track_number, duration) VALUES (12,1,'That''s All',10,368);
  INSERT INTO track (id, album_id, title, track_number, duration) VALUES (11,11,'Lover Man',2,185);
  INSERT INTO track (id, album_id, title, track_number, duration) VALUES (13,11,'Johnny B. Goode',1,285);
  ...
  INSERT INTO track (id, album_id, title, track_number, duration) VALUES (22,2,'Drive My Car',1,150);
  INSERT INTO track (id, album_id, title, track_number, duration) VALUES (23,2,'Norwegian Wood (This Bird Has Flown)',2,125);
  INSERT INTO track (id, album_id, title, track_number, duration) VALUES (24,2,'You Won''t See Me',3,202);
  ...
  INSERT INTO track (id, album_id, title, track_number, duration) VALUES (70,999,'Fake Track',9,549);
  COMMIT;


--Alt insert method

INSERT INTO track (id, album_id, title, track_number, duration) VALUES
